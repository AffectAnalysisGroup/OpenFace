...
# New functionalities
Modified occurence SVM output to include max-margin distance. It is saved as `AUx_d` in the output csv files. This is tested on `FeatureExtraction` executable only. However, it should work with others too.
