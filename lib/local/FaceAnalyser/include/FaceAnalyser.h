...
public:
	...
	std::tuple<std::vector<std::pair<std::string, double>>, std::vector<std::pair<std::string, double>>> GetCurrentAUsClass() const; // AU presence
	...
	void ExtractAllPredictionsOfflineClass(std::vector<std::pair<std::string, std::vector<double>>>& au_distances, std::vector<std::pair<std::string, 
		std::vector<double>>>& au_predictions, std::vector<double>& confidences, std::vector<bool>& successes, std::vector<double>& timestamps, 
		bool dynamic);
...
private:
	...
	//std::tuple<std::vector<std::pair<std::string, double>>, std::vector<std::pair<std::string, double>>> AU_predictions_class;
    // Added for SVM distance
	std::vector<std::pair<std::string, double>> AU_predictions_distances;
    ...
    // Added for SVM distance
	std::map<std::string, std::vector<double>> AU_predictions_distances_all_hist;
	...
	std::tuple<std::vector<std::pair<std::string, double>>, std::vector<std::pair<std::string, double>>> PredictCurrentAUsClass(int view);
