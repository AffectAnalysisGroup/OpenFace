...
void Visualizer::SetObservationActionUnits(const std::vector<std::pair<std::string, double> >& au_intensities,
	const std::tuple<std::vector<std::pair<std::string, double>>, std::vector<std::pair<std::string, double>>>& au_occurence)
{
	// ignore the distance in visualizations and consider only the probabilities
	std::vector<std::pair<std::string, double>> au_occurences = std::get<0>(au_occurence);
